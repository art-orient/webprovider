...
<header style="display:flex;justify-content:flex-end;align-items:center;background-color:#002244;padding:10px 20px;">
    <div style="margin-right:auto;">
        <a href="index.jsp" style="color:white;text-decoration:none;font-weight:bold;">АртТелеком</a>
    </div>
    <a href="#" style="color:white;margin-left:20px;text-decoration:none;font-weight:bold;">Вход</a>
